...
class QueryBuilderImpl  {
    ...
    class Logic  {
        ...
        static void whereTransitionWhere(QueryBuilderImpl::Content content, Types::Expression expression);
        ...
        static Types::Query buildQueryTransformationBuild(QueryBuilderImpl::Content content);
    };
};
}
